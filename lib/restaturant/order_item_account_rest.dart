...
import 'package:vendor/restaturant/item_restpage.dart';
import 'package:vendor/restaturant/restorderpage.dart';

class OrderItemAccountRest extends StatefulWidget {
  @override
  _OrderItemAccountRestState createState() => _OrderItemAccountRestState();
}

class _OrderItemAccountRestState extends State<OrderItemAccountRest> {
  int _currentIndex = 0;
