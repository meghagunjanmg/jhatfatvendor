  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title:
        Text('Add Subcategory', style: Theme.of(context).textTheme.bodyText1),
        titleSpacing: 0.0,
      ),
      body: Add(),
    );
...
class AddState extends State<Add> {
  ...
  void newHitService(ProgressDialog pr, BuildContext context) async {
    pr.show();
    var store_addsubcategoryUrl = store_addsubcategory;
    var client = http.Client();
    client.post(store_addsubcategoryUrl, body: {
